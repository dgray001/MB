...
public class MD {
	...
	public static void main(String[] args) {
                ...
                if (osname.startsWith("windows")) {
                  filePath = "C:\\Users\\Yo-Dan\\Documents\\School\\Internships\\Summer 2018-Duquesne\\Java_MD_Data\\";
                } else if (osname.startsWith("linux")) {
                  filePath = "/home/zucc/Documents/School/2019_Spring/MB/Java_Files/";
                }
		...
		double I_HB = 0;
                ...
                try {
                        parameters = new FileReader(filePath + "MDparameters");
                        BufferedReader pm = new BufferedReader(parameters);
                        String line = pm.readLine();
                        String[] ln = line.split("=");
                        n = Integer.parseInt(ln[1]);
                        line = pm.readLine();
                        ln = line.split("=");
                        s = Integer.parseInt(ln[1]);
                        line = pm.readLine();
                        ln = line.split("=");
                        c = Integer.parseInt(ln[1]);
                        line = pm.readLine();
                        ln = line.split("=");
                        time_total = Double.parseDouble(ln[1]);
                        line = pm.readLine();
                        ln = line.split("=");
                        rho = Double.parseDouble(ln[1]);
                        line = pm.readLine();
                        ln = line.split("=");
                        kBT = Double.parseDouble(ln[1]);
                        line = pm.readLine();
                        ln = line.split("=");
                        int nve = Integer.parseInt(ln[1]);
                        if (nve == 1) {
                                NVE = true;
                        }
			line = pm.readLine();
			ln = line.split("=");
			I_HB = Double.parseDouble(ln[1]);
                } catch(IOException e) {
                        System.out.println("Couldn't find or open MDparameters file");
                        e.printStackTrace();
                }
